...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <button type="submit" class="btn btn-primary" name="submit">Generate Barcodes</button>
            <button type="submit" class="btn btn-danger" name="clear_data">Clear Data</button>
        </form>
